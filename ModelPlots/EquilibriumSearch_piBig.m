...
% Variables needed for figure 7a, price, VL, VH
...
figure; plot(tgrid,peqm,tgrid,VL,tgrid,VH); %figure 6a

% Variables needed for figure 6b, Strategic trade, Liquidity trade, total trade.
...
%figure; plot(tgrid,GammaL_prime) 
...
plot(tgrid,strat,tgrid,liq,tgrid,tot) %figure 6b
