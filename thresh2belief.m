function [bb,Gam_H,gam_H,lam_H,Gam_L,gam_L,lam_L] = thresh2belief(tt,st,ns,b0,lam0,mu_H,mu_L,sig)
...
%}
    ...
    function [Gam,gam,lam] = Gamma(mu)
        ...
        gam = gam*(Gam(end));
        %gam = zeros(1,length(Gam));
        %gam(2:end) = diff(Gam)/dt;
        lam = gam./(1-Gam);
